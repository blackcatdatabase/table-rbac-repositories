...
> Lineage: 1 outbound / 3 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 2 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\rbac-repositories](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-repositories) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-repositories -Apply
