...
final class RbacRepositoriesModule implements ModuleInterface
{
    public function name(): string { return 'table-rbac_repositories'; }
    public function table(): string { return 'rbac_repositories'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-signing_keys' ]; }

    public static function contractView(): string { return 'vw_rbac_repositories'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rbac_repos_status' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_rbac_repos_sign_key' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rbac_repos_status' ],
            'foreignKeys' => [ 'fk_rbac_repos_sign_key' ],
        ];
    }
}
