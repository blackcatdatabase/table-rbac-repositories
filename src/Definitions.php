...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_repositories'; }
    public static function contractView(): string { return 'vw_rbac_repositories'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'url', 'signing_key_id', 'status', 'last_synced_at', 'last_commit', 'created_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'signing_key_id' ]; }
