...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'name', 'url', 'signing_key_id', 'status', 'last_synced_at', 'last_commit', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RbacRepositories\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RbacRepositories\Definitions::softDeleteColumn();
