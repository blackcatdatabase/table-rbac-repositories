...
namespace BlackCat\Database\Packages\RbacRepositories\Mapper;

use BlackCat\Database\Packages\RbacRepositories\Dto\RbacRepositoryDto;
use BlackCat\Database\Packages\RbacRepositories\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacRepositoryDto:
...
final class RbacRepositoryDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'signing_key_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'last_synced_at', 'created_at' ];
    /** @var string[] */
     ...
     * @return RbacRepositoryDto
     */
    public static function fromRow(array $row): RbacRepositoryDto
    {
        /** @var RbacRepositoryDto */
        return DtoHydrator::fromRow(
            RbacRepositoryDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RbacRepositoryDto
    {
     ...
     *
     * @param RbacRepositoryDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacRepositoryDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacRepositoryDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacRepositoryDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacRepositoryDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacRepositoryDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacRepositoryDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacRepositoryDto>
     */
