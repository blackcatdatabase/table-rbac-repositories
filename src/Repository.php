...
use BlackCat\Database\Packages\RbacRepositories\Repository\RbacRepositoryRepository;
...
{
    private RbacRepositoryRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RbacRepositoryRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepositories\Dto\RbacRepositoryDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RbacRepositories\Dto\RbacRepositoryDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepositories\Dto\RbacRepositoryDto|null
    {
