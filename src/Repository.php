...
namespace BlackCat\Database\Packages\RbacRepositories;
...
use BlackCat\Database\Packages\RbacRepositories\Repository\RbacRepositoryRepository as GeneratedRepository;
...
{
  private RbacRepositoryRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacRepositoryRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacRepositoryRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepositories\Dto\RbacRepositoryDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepositories\Dto\RbacRepositoryDto|null { return $this->repo->getById($id, $asDto); }
