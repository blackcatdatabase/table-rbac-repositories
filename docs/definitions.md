...
| last_synced_at | TIMESTAMPTZ(6) | YES |  | Last successful sync time. |
...
| status | TEXT | NO | active | Repository status. (enum: active, disabled) |
| url |  | YES |  | Optional URL/endpoint. |
...
| --- | --- | --- | --- |
| vw_rbac_repositories | mysql | algorithm=MERGE, security=INVOKER | [packages\rbac-repositories\schema\040_views.mysql.sql](https://github.com/blackcatacademy/blackcat-database/packages/rbac-repositories/schema/040_views.mysql.sql) |
| vw_rbac_repositories | postgres |  | [packages\rbac-repositories\schema\040_views.postgres.sql](https://github.com/blackcatacademy/blackcat-database/packages/rbac-repositories/schema/040_views.postgres.sql) |
